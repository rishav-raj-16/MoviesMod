...
import com.rishavraj.moviesmode.movieList.presentaion.components.MovieItem
import com.rishavraj.moviesmode.movieList.util.Category


@Composable
fun PopularsMovieScreen(
